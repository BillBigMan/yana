  ...
  return (
    <section className="relative min-h-screen pt-10 flex items-center overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50/20 to-orange-50/10">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute bottom-[-10%] right-[-5%] w-[45%] h-[45%] bg-gradient-to-tl from-orange-400/20 to-orange-600/10 rounded-full blur-[120px] animate-blob-slow"
          style={{ animationDelay: "3s" }}
        />
        <div
          className="absolute top-[30%] right-[15%] w-[30%] h-[30%] bg-gradient-to-br from-purple-400/10 to-pink-400/5 rounded-full blur-[100px] animate-blob-slow"
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center gap-4 lg:gap-6 max-w-5xl mx-auto py-4">
            <div className="lg:w-1/2 text-left py-4">
              ...
              <h1 className="text-3xl md:text-5xl font-bold tracking-tight text-gray-900 mb-4 leading-[1.1]">
                <span
                  className="animate-fade-in-up inline"
              ...
              {/* Subtitle */}
              <p
                className="text-base text-gray-600 mb-6 max-w-xl leading-relaxed animate-fade-in-up"
              ...
              {/* CTA Buttons */}
              <div
                className="flex flex-col lg:flex-row gap-3 animate-fade-in-up"
                style={{ animationDelay: "0.5s" }}
              >
                <Button
                  size="md"
            ...
            <div className="lg:w-1/2 relative">
              ...
              <div className="relative z-10 max-w-[80%] mx-auto group">
                ...
                <div
                  className="absolute top-1/2 -left-8 w-12 h-12 bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl flex items-center justify-center shadow-lg animate-float-slow group-hover:scale-110 transition-transform"
              ...
              <div
                className="absolute bottom-0 left-0 w-56 h-56 bg-gradient-to-tr from-orange-400/10 to-pink-400/10 rounded-full blur-3xl animate-pulse"
                style={{ animationDelay: "1s" }}
              />
              ...
              <div
                className="absolute top-1/3 right-20 text-orange-400 animate-twinkle"
                style={{ animationDelay: "1s" }}
              >
